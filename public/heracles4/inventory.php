<aside id="hero" class="hero">
    ...
    <div class="slots equipment">
        <div data-slot="Main weapon" class="slot">
            <?php use Heracles4\Level; if (method_exists($arena->getHero(), 'getWeapon') && $arena->getHero()->getWeapon() !== null) : ?>
    ...
    <div class="character">
        <h4 class="name"><?= $arena->getHero()->getName() ?></h4>
        <div class="avatar">
            <img src="<?= $arena->getHero()->getImage() ?>" alt="heracles">
        </div>
        <div>
            <div class="level">Level
                <?php if (class_exists('Heracles4\Level') && method_exists($arena->getHero(), 'getExperience')) {
